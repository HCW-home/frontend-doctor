...
import { InvitationAlreadyAcceptedComponent, InvitationsComponent } from './invitations/invitations.component';
...
@NgModule({
  ...
  entryComponents: [InviteFormComponent, ProfileUpdateComponent, FooterComponent, ConfirmationDialogComponent]
